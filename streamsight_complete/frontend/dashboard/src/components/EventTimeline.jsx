// const EVENT_CONFIG = {
//   page_view:     { icon: "👁",  color: "#64748b", bg: "rgba(100,116,139,0.1)" },
//   add_to_cart:   { icon: "🛒", color: "#0088ff", bg: "rgba(0,136,255,0.1)"   },
//   checkout:      { icon: "💳", color: "#a855f7", bg: "rgba(168,85,247,0.1)"  },
//   purchase:      { icon: "✅", color: "#00d4aa", bg: "rgba(0,212,170,0.1)"   },
//   search:        { icon: "🔍", color: "#ffd60a", bg: "rgba(255,214,10,0.1)"  },
//   product_click: { icon: "🖱",  color: "#ff4d6d", bg: "rgba(255,77,109,0.1)" },
// };
...
//           <p className="text-slate-400 text-xs mt-0.5">Last {events.length} events</p>
//         </div>
//         <div className="flex items-center gap-2 text-xs mono px-3 py-1.5 rounded-full"
...
//           <span style={{ color: "#00d4aa" }}>STREAMING</span>
//         </div>
//       </div>

//       {events.length === 0 ? (
//         <div className="flex items-center justify-center py-10 gap-3 text-slate-500 text-sm">
//           <div className="w-5 h-5 border-2 border-emerald-500/30 border-t-emerald-500 rounded-full"
...
//                 {["Event", "User", "Page", "Device", "Country", "Time"].map(h => (
...
//                   <tr
//                     key={i}
//                     className="event-row border-b border-slate-800/50 group hover:bg-white/[0.02] transition-colors cursor-default"
//                     style={{ animationDelay: `${i * 0.03}s` }}
//                   >
//                     {/* Event type */}
//                     <td className="py-2.5 pr-4">
//                       <div className="flex items-center gap-2">
//                         <span className="w-7 h-7 rounded-lg flex items-center justify-center text-sm transition-transform duration-200 group-hover:scale-110"
//                           style={{ background: cfg.bg }}>
//                           {cfg.icon}
//                         </span>
//                         <span className="font-medium capitalize mono"
...
//                     {/* User */}
//                     <td className="py-2.5 pr-4">
//                       <span className="mono text-slate-300 group-hover:text-white transition-colors">{e.user_id}</span>
//                     </td>

//                     {/* Page */}
//                     <td className="py-2.5 pr-4">
//                       <span className="mono text-slate-500 group-hover:text-slate-400 transition-colors truncate max-w-[120px] block">{e.page}</span>
//                     </td>

//                     {/* Device */}
//                     <td className="py-2.5 pr-4">
//                       <span className="flex items-center gap-1.5 text-slate-400">
//                         <span>{DEVICE_ICONS[e.device] || "💻"}</span>
//                         <span className="mono capitalize">{e.device}</span>
//                       </span>
//                     </td>

//                     {/* Country */}
//                     <td className="py-2.5 pr-4">
//                       <span className="mono px-2 py-0.5 rounded text-xs font-medium"
...
//                     {/* Time */}
//                     <td className="py-2.5">
//                       <span className="mono text-slate-500 group-hover:text-slate-400 transition-colors">{formatTime(e.timestamp)}</span>
//                     </td>
//                   </tr>
//                 );
//               })}
...
//   Search, MouseOutlined, DesktopMacOutlined, SmartphoneOutlined, TabletMacOutlined,
//   FiberManualRecord,
// } from "@mui/icons-material";

// // ── EVENT_CONFIG — unchanged values, refined styling ───────────────────────
// const EVENT_CONFIG = {
//   page_view:     { Icon: Visibility,          color: "#64748B", bg: "#F1F5F9", label: "Page View"     },
//   add_to_cart:   { Icon: AddShoppingCart,     color: "#185FA5", bg: "#E6F1FB", label: "Add to Cart"   },
//   checkout:      { Icon: Payment,             color: "#534AB7", bg: "#EEEDFE", label: "Checkout"       },
//   purchase:      { Icon: CheckCircleOutline,  color: "#0F6E56", bg: "#E1F5EE", label: "Purchase"       },
//   search:        { Icon: Search,              color: "#854F0B", bg: "#FAEEDA", label: "Search"         },
//   product_click: { Icon: MouseOutlined,       color: "#993C1D", bg: "#FAECE7", label: "Product Click"  },
// };
...
// // Country → color mapping for badges
// const COUNTRY_COLORS = {
//   IN: { bg: "#E6F1FB", fg: "#185FA5" },
//   UK: { bg: "#EEEDFE", fg: "#534AB7" },
//   US: { bg: "#E1F5EE", fg: "#0F6E56" },
//   DE: { bg: "#FAEEDA", fg: "#854F0B" },
//   SG: { bg: "#FBEAF0", fg: "#993556" },
//   AU: { bg: "#FAECE7", fg: "#993C1D" },
//   JP: { bg: "#EAF3DE", fg: "#3B6D11" },
//   FR: { bg: "#FCEBEB", fg: "#A32D2D" },
// };
...
//         fontSize: 9, fontWeight: 700, border: `1px solid ${c.fg}20`,
//         cursor: "default",
//       }}>{initials}</div>
//     </Tooltip>
//   );
...
//             Live Event Stream
//           </div>
//           <div style={{ color: "#475569", fontSize: 12, marginTop: 3 }}>Last {events.length} events</div>
//         </div>
//         <div style={{
...
//           }} />
//           <span style={{ fontSize: 11, fontFamily: "'DM Mono',monospace", color: "#1D9E75", fontWeight: 600 }}>
//             STREAMING
//           </span>
//         </div>
//       </div>
...
//       {/* ── Empty state ── */}
//       {events.length === 0 ? (
//         <div style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "40px 0", gap: 12, color: "#475569", fontSize: 14 }}>
//           <div style={{
//             width: 20, height: 20,
...
//         {/* SEARCH & FILTER BAR */}
// <Box sx={{ 
//   display: "flex", gap: 2, mb: 3, p: "12px 20px", 
...
//     style={{
//       padding: "11px 16px", background: "rgba(15, 23, 42, 0.6)",
//       border: "1px solid rgba(255,255,255,0.1)", borderRadius: "10px",
//       color: "#f8fafc", fontSize: "0.85rem", cursor: "pointer", outline: "none"
//     }}
//   >
//     <option value="all">All Events</option>
//     {Object.keys(EVENT_CONFIG).map(key => (
//       <option key={key} value={key}>{EVENT_CONFIG[key].label}</option>
//     ))}
//   </select>
// </Box>
...
//         {["Event", "User", "Page", "Device", "Country", "Time"].map((h, i) => (
//           <th key={h} style={{
...
//                     display: "flex", alignItems: "center", justifyContent: "center",
//                     boxShadow: `0 0 15px ${cfg.color}10` // Subtle Glow
//                   }}>
//                     <cfg.Icon style={{ fontSize: 16, color: cfg.color }} />
//                   </div>
//                   <span style={{ fontWeight: 600, color: "#f8fafc", fontSize: 13 }}>{cfg.label}</span>
//                 </div>
//               </td>
...
//                   <span style={{ color: "#cbd5e1", fontFamily: "JetBrains Mono" }}>{e.user_id}</span>
//                 </div>
//               </td>

//               <td style={{ padding: "14px 16px" }}>
//                 <code style={{ color: "#3b82f6", background: "#3b82f610", padding: "4px 8px", borderRadius: "6px" }}>
//                   {e.page}
//                 </code>
//               </td>
...
//                     <devCfg.Icon style={{ fontSize: 18 }} />
//                     {devCfg.label}
//                  </div>
//               </td>

//               <td style={{ padding: "14px 16px" }}>
//                 <span style={{ color: "#f8fafc", fontWeight: 500 }}>{e.country}</span>
//               </td>
...
//       <style>{`
//         @keyframes et-pulse { 0%,100%{opacity:1;transform:scale(1)} 50%{opacity:.55;transform:scale(.8)} }
...
// import { motion, AnimatePresence } from "framer-motion";
// import { Tooltip, Box, Typography } from "@mui/material"; // Added Box and Typography imports
// import {
//   Visibility, AddShoppingCart, Payment, CheckCircleOutline,
//   Search, MouseOutlined, DesktopMacOutlined, SmartphoneOutlined, TabletMacOutlined,
// } from "@mui/icons-material";

// // ... [EVENT_CONFIG, DEVICE_CONFIG, COUNTRY_COLORS, USER_COLORS, hashColor, formatTime, UserAvatar remain same] ...
// const EVENT_CONFIG = {
...
// export default function EventTimeline({ events = [] }) {
//   // ── FIX: Added State hooks ──────────────────────────────────────────
//   const [searchTerm, setSearchTerm] = useState("");
//   const [filterType, setFilterType] = useState("all");

//   // ── FIX: Added Filtering Logic ──────────────────────────────────────
...
//             Live Event Stream
//           </div>
//           <div style={{ color: "#475569", fontSize: 12, marginTop: 3 }}>Last {filteredEvents.length} events</div>
//         </div>
//         <div style={{
//           display: "flex", alignItems: "center", gap: 7,
//           padding: "5px 14px", borderRadius: 20,
...
//               <option value="all">All Events</option>
//               {Object.keys(EVENT_CONFIG).map(key => (
//                 <option key={key} value={key} style={{background: "#111927"}}>{EVENT_CONFIG[key].label}</option>
//               ))}
//             </select>
//           </Box>
...
//                           <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
//                             <UserAvatar userId={e.user_id} />
//                             <span style={{ color: "#cbd5e1", fontFamily: "'DM Mono', monospace" }}>{e.user_id}</span>
//                           </div>
//                         </td>

//                         <td style={{ padding: "14px 16px" }}>
//                           <code style={{ color: "#3b82f6", background: "#3b82f610", padding: "4px 8px", borderRadius: "6px", fontSize: 11 }}>
//                             {e.page}
//                           </code>
//                         </td>
...
//                         <td style={{ padding: "14px 16px" }}>
//                           <span style={{ color: "#f8fafc", fontWeight: 500 }}>{e.country || "N/A"}</span>
//                         </td>
