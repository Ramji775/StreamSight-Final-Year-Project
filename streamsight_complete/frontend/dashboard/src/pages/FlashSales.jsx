...
const FLASH_ITEMS = [
  { id: 1, name: "Gaming Console Z", discount: "40% OFF", price: 299, original: 499, claimed: 88, img: "https://images.unsplash.com/photo-1605902711622-cfb43c4437b5?w=400" },
  { id: 2, name: "Wireless Earbuds Pro", discount: "60% OFF", price: 49, original: 129, claimed: 40, img: "https://images.unsplash.com/photo-1590658268037-6bf12165a8df?w=400" },
  { id: 3, name: "Mechanical Keyboard", discount: "25% OFF", price: 89, original: 119, claimed: 15, img: "https://images.unsplash.com/photo-1511467687858-23d96c32e4ae?w=400" },
];
    ...
    <Box sx={{ p: { xs: 2, md: 4 }, maxWidth: 1200, margin: "0 auto", bgcolor: '#f8fafc', minHeight: '100vh' }}>
      ...
      <Box sx={{ 
        ...
        <Stack direction="row" spacing={1} alignItems="center">
          ...
          <Box>
            <Typography variant="h5" sx={{ fontWeight: 900, color: '#0f172a', lineHeight: 1 }}>FLASH SALE</Typography>
            <Typography variant="caption" sx={{ color: '#64748b', fontWeight: 600 }}>Limited time, limited stock</Typography>
          </Box>
        </Stack>

        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, bgcolor: '#fef2f2', p: 1.5, borderRadius: 2 }}>
          <Timer sx={{ color: '#ef4444' }} />
          <Typography sx={{ color: '#ef4444', fontWeight: 800, fontFamily: 'monospace', fontSize: '1.2rem' }}>
            {formatTime(timeLeft.h)}:{formatTime(timeLeft.h)}:{formatTime(timeLeft.s)}
          </Typography>
        </Box>
      </Box>
              ...
              <Box sx={{ p: 3 }}>
                ...
                <Box sx={{ mb: 3 }}>
                  <Stack direction="row" justifyContent="space-between" sx={{ mb: 1 }}>
                    <Typography sx={{ fontSize: '0.8rem', fontWeight: 700, color: item.claimed > 80 ? '#ef4444' : '#64748b' }}>
                      {item.claimed}% SOLD
                    </Typography>
